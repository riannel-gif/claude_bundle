...
push(
  ...
  { n: [
    ...
    "**GRIP is real and recent:** launched July 2025 by the Forum with the United Arab Emirates; a two-year roadmap; three deliverables — a **Global Regulatory Playbook**, a **Regulatory Future Readiness Index**, and a **Global Regulatory Innovation Hub** (a pilot environment to test and refine rules before scaling). Treat the report and convening work as live, and the Playbook and Index as still being built out — verify current status before the interview.",
...
push(
  ...
  { p: "Five principles are now the shared vocabulary of the field. They were crystallised by **Deloitte’s *The Future of Regulation* (Eggers, Turley and Kishnani, 2018)** and echoed in the Forum’s own **“Agile Regulation for the Fourth Industrial Revolution: A Toolkit for Regulators” (2020)**. Attribute them accurately if asked — knowing they are Deloitte’s framing, adopted into Forum practice, is itself a mark of fluency. Memorise all five and you can speak the field’s house language:" },
...
push(
  ...
  { b: [
    ...
    "**United Kingdom** — a deliberately **principles-based, pro-innovation** approach that empowers existing sector regulators rather than creating one AI law, paired with the **AI Security Institute** (renamed from the AI Safety Institute in early 2025, in a telling pivot from “safety” toward security and criminal-misuse threats) for frontier-model evaluation.",
...
push(
  ...
  { table: { head: ["Forum work", "What it established", "Use it to…"], widths: [3050, 3550, 2760], rows: [
    ...
    ["Agile Regulation for the 4IR — A Toolkit for Regulators (2020)", "A practical toolkit of agile techniques (sandboxes, one-stop shops, challenges), building on the five-principles approach (§2.2).", "Speak the Forum’s house vocabulary precisely."],
